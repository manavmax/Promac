    ...
    <div className="space-y-8">
      ...
      <div className="bg-card rounded-lg border border-border p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <label className="flex items-center space-x-2 cursor-pointer">
            ...
            />
            <span className="text-sm text-muted-foreground">Same as delivery address</span>
          </label>
        </div>
      ...
      <div className="bg-card rounded-lg border border-border p-6">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-foreground mb-3">Invoice Type</label>
      ...
      <div className="bg-muted/50 rounded-lg p-6">
        <div className="flex items-start space-x-3">
          ...
          <div className="text-sm text-muted-foreground">
            <p className="font-medium text-foreground mb-2">GST Information:</p>
