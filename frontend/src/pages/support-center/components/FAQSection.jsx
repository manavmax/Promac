      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          {filteredFAQs.map((faq, index) => (
            <div
              key={faq.id}
              className={`group bg-white/5 backdrop-blur-2xl rounded-2xl border border-white/20 overflow-hidden transition-all duration-500 hover:border-[#ff0c0e]/50 hover:shadow-xl hover:shadow-[#ff0c0e]/10 shadow-lg shadow-black/20 ${
                openFAQ === faq.id ? 'ring-2 ring-[#ff0c0e]/20' : ''
              }`}
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-[#ff0c0e] transition-colors duration-300">
                      {faq.question}
                    </h3>
                  ...
                  <div className={`ml-4 w-8 h-8 bg-white rounded-full flex items-center justify-center transition-transform duration-300 ${
                  ...
                  <div className="border-t border-[#374151] pt-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <button className="flex items-center space-x-2 text-[#ff0c0e] hover:text-[#e00b0c] transition-colors duration-200">
