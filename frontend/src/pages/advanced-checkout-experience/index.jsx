        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className={`transition-all duration-300 ${
              ...
              <div className="fixed top-24 right-4 w-80 z-50 lg:relative lg:top-auto lg:right-auto lg:w-auto lg:z-auto">
                <OrderSummary
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div className="flex flex-col items-center space-y-2">
                ...
                <div>
                  <h3 className="text-sm font-light text-black">SSL Secured</h3>
                  <p className="text-xs text-gray-600 font-light">256-bit encryption</p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <div>
                  <h3 className="text-sm font-light text-black">BIS Certified</h3>
                  <p className="text-xs text-gray-600 font-light">Quality assured</p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <div>
                  <h3 className="text-sm font-light text-black">25+ Years</h3>
                  <p className="text-xs text-gray-600 font-light">Trusted experience</p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <div>
                  <h3 className="text-sm font-light text-black">Free Delivery</h3>
                  <p className="text-xs text-gray-600 font-light">Orders above ₹5,000</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 text-center">
              <p className="text-xs text-gray-600 font-light">
                ...
                <span className="text-red-600 mx-1">Privacy Policy</span> | 
                <span className="text-red-600 mx-1">Terms of Service</span> | 
                <span className="text-red-600 mx-1">Support: 1800-123-4567</span>
              </p>
            </div>
          </div>
        </div>
